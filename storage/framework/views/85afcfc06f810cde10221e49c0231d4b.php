        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 relative z-10">
                        ...
                        <div class="flex flex-col items-center shrink-0">
                            <div class="w-24 h-24 sm:w-28 sm:h-28 bg-gradient-to-tr from-indigo-100 to-white border-2 border-indigo-200 rounded-full flex items-center justify-center shadow-lg shadow-indigo-100/50 mb-3">
                                <span class="text-3xl sm:text-4xl font-bold text-indigo-600">
                                    <?php echo e(mb_substr($profile->display_name, 0, 1)); ?>
                            ...
                            <?php elseif($profile->verification_status === 'unverified'): ?>
                        ...
                        <div class="flex-1 text-center sm:text-right">
                            <div class="flex items-center justify-center sm:justify-start gap-3 mb-2 flex-wrap">
                                <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900"><?php echo e($profile->display_name); ?></h1>
                                ...
                                <button wire:click.prevent="toggleFavorite" class="p-2 rounded-full hover:bg-red-50 text-gray-400 hover:text-red-500 transition duration-300 focus:outline-none flex-shrink-0 relative group" title="المفضلة" wire:loading.attr="disabled">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFavorited): ?>
                            ...
                            <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2 text-gray-600 font-medium mb-3">
                                <span class="bg-indigo-50 text-indigo-700 px-3 py-1 rounded-lg text-sm"><?php echo e(optional($profile->category)->name); ?></span>
                                ...
                                <span class="flex items-center gap-1 text-sm bg-gray-50 px-3 py-1 rounded-lg">
                                    ...
                                    <?php echo e(optional($profile->city)->name); ?><?php echo e($profile->district ? ' ، ' . optional($profile->district)->name : ''); ?>
                            ...
                            <div class="flex flex-wrap items-center justify-center sm:justify-start gap-3">
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span class="font-bold text-gray-900"><?php echo e(number_format($profile->rating_avg, 1)); ?></span>
                                    <a href="#reviews" class="text-sm font-medium text-indigo-600 hover:text-indigo-800 transition underline underline-offset-4">(<?php echo e($profile->rating_count); ?> تقييم)</a>
                                </div>
                                ...
                                <?php elseif($profile->availability_status === 'offline' || $profile->availability_status === 'out_of_service'): ?>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->gallery->isNotEmpty()): ?>
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $profile->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="aspect-square rounded-xl overflow-hidden bg-gray-50 border border-gray-100 group relative shadow-sm">
                                    <img src="<?php echo e(!empty($image->image_path) ? asset('storage/' . $image->image_path) : asset('/images/default-profile.png')); ?>" alt="<?php echo e($image->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500 cursor-pointer">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($image->title): ?>
            ...
            <div class="space-y-6 lg:sticky lg:top-24 self-start">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($profile->views_count) || isset($profile->reviews_count)): ?>
                <div class="bg-white rounded-xl shadow-sm p-4 text-center grid grid-cols-2 divide-x divide-x-reverse divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($profile->views_count)): ?>
                    <div class="px-2">
                        <div class="text-sm text-gray-500 mb-1">المشاهدات</div>
                        <div class="font-bold text-gray-900">شوهد <?php echo e(number_format($profile->views_count)); ?> مرة</div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->rating_count > 0): ?>
                    <div class="px-2">
                        <div class="text-sm text-gray-500 mb-1">التقييمات</div>
                        <div class="font-bold text-gray-900"><?php echo e(number_format($profile->rating_count)); ?> تقييم</div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bg-white rounded-xl shadow-sm p-4">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-3 rounded-xl transition duration-200 border border-gray-200">
                            <span class="flex items-center justify-center gap-2">
                ...
                <div class="lg:hidden fixed pb-4 bottom-20 inset-x-4 z-50 pointer-events-none">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="w-full flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-900 text-white font-bold py-4 rounded-xl transition duration-300 shadow-xl shadow-gray-900/40 text-lg border border-gray-700">
                ...
                <div class="bg-indigo-600 rounded-xl shadow-sm p-6 text-white text-center relative overflow-hidden">
                    ...
                    <div class="text-5xl font-extrabold tracking-tighter mb-2"><?php echo e(number_format($profile->rating_avg, 1)); ?></div>

                    <div class="flex items-center justify-center gap-0.5 mb-2 text-amber-300">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="<?php echo e($i <= round($profile->rating_avg) ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="1.5" class="w-5 h-5">
                              <path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clip-rule="evenodd" />
                            </svg>
                        <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>

                    <div class="text-indigo-100/80 font-medium text-sm">بناءً على <?php echo e($profile->rating_count); ?> تقييم</div>
                </div>
                ...
                <div id="reviews" class="bg-white rounded-xl shadow-sm p-6 scroll-mt-24">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::id() !== $this->profile->user_id): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$this->hasReviewed): ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center gap-1 flex-row-reverse justify-end w-max" x-data="{ hoverRating: 0 }">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 5; $i >= 1; $i--): ?>
                                                    <button type="button"
                                                        wire:click="$set('reviewRating', <?php echo e($i); ?>)"
                                                        @mouseenter="hoverRating = <?php echo e($i); ?>"
                                                        @mouseleave="hoverRating = 0"
                                                        class="focus:outline-none transition"
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            :class="{'text-amber-400': hoverRating >= <?php echo e($i); ?> || (hoverRating === 0 && $wire.reviewRating >= <?php echo e($i); ?>), 'text-gray-200': !(hoverRating >= <?php echo e($i); ?> || (hoverRating === 0 && $wire.reviewRating >= <?php echo e($i); ?>))}"
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['reviewRating'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->reviews->isEmpty()): ?>
                        <div class="text-center py-8 bg-gray-50 rounded-xl border border-dashed border-gray-200">
                            <svg class="mx-auto w-10 h-10 text-gray-300 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <?php else: ?>
                        <div class="space-y-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $profile->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="border-b border-gray-50 pb-4 last:border-0 last:pb-0">
                                    <div class="flex items-center justify-between mb-1.5">
                                        <div class="font-bold text-gray-900 text-sm"><?php echo e(optional($review->user)->name ?: 'زائر'); ?></div>
                                        <div class="text-xs text-gray-400"><?php echo e($review->created_at->diffForHumans()); ?></div>
                                    </div>

                                    <div class="flex items-center gap-0.5 mb-1.5 text-amber-400">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 5; $i++): ?>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="<?php echo e($i <= $review->rating ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="1.5" class="w-3.5 h-3.5 <?php echo e($i > $review->rating ? 'text-gray-200' : ''); ?>">
                                              <path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clip-rule="evenodd" />
                                            </svg>
                                        <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
...
<?php /**PATH C:\Users\Mugahed\Desktop\MyMetier\resources\views/livewire/professional-profile-page.blade.php ENDPATH**/ ?>