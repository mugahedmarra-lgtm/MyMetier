...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="rtl">
    <head>
        ...
        <title><?php echo e($title ?? 'MyMetier - Service Marketplace'); ?></title>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($metaDescription)): ?>
    ...
    <body class="antialiased bg-gray-50 text-gray-900">
        ...
        <div x-data="{
                ...
                <nav class="flex-1 px-3 pt-4 pb-4 space-y-1">
                    ...
                    <a href="<?php echo e(route('home')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition duration-200 group
                              <?php echo e(request()->is('/') ? 'nav-link-active' : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600'); ?>"
                       title="الرئيسية">
                        <span class="nav-icon-box w-8 h-8 rounded-lg flex items-center justify-center transition duration-200 flex-shrink-0
                                     <?php echo e(request()->is('/') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-indigo-50 group-hover:text-indigo-500'); ?>">
                    ...
                    <a href="<?php echo e(route('search')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition duration-200 group
                              <?php echo e(request()->is('search*') ? 'nav-link-active' : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600'); ?>"
                       title="البحث">
                        <span class="nav-icon-box w-8 h-8 rounded-lg flex items-center justify-center transition duration-200 flex-shrink-0
                                     <?php echo e(request()->is('search*') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-indigo-50 group-hover:text-indigo-500'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-[18px] h-[18px]">
                    ...
                    <a href="<?php echo e(route('requests.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition duration-200 group
                              <?php echo e(request()->is('requests') ? 'nav-link-active' : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600'); ?>"
                       title="الطلبات">
                        <span class="nav-icon-box w-8 h-8 rounded-lg flex items-center justify-center transition duration-200 flex-shrink-0
                                     <?php echo e(request()->is('requests') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-indigo-50 group-hover:text-indigo-500'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-[18px] h-[18px]">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e($isPro ? route('pro.dashboard') : route('dashboard')); ?>"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition duration-200 group
                                  <?php echo e(request()->is('dashboard') || request()->is('pro-dashboard') ? 'nav-link-active' : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600'); ?>"
                           title="لوحة التحكم">
                            <span class="nav-icon-box w-8 h-8 rounded-lg flex items-center justify-center transition duration-200 flex-shrink-0
                                         <?php echo e(request()->is('dashboard') || request()->is('pro-dashboard') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-indigo-50 group-hover:text-indigo-500'); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-[18px] h-[18px]">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPro): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->professionalProfile): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->professionalProfile->isActive()): ?>
                                    <a href="<?php echo e(route('profile.show', $user->professionalProfile->id)); ?>"
                                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition duration-200 group text-gray-600 hover:bg-gray-50 hover:text-indigo-600"
                                       title="ملفي المهني">
                                        <span class="nav-icon-box w-8 h-8 rounded-lg flex items-center justify-center bg-gray-100 text-gray-500 group-hover:bg-indigo-50 group-hover:text-indigo-500 transition duration-200 flex-shrink-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-[18px] h-[18px]">
                                ...
                                <?php elseif($user->professionalProfile->profile_status === 'pending_review'): ?>
                                ...
                                <?php elseif($user->professionalProfile->profile_status === 'rejected'): ?>
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php else: ?>
                            <a href="<?php echo e(route('upgrade')); ?>"
                               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition duration-200 group
                                      <?php echo e(request()->is('upgrade') ? 'nav-link-active' : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600'); ?>"
                               title="ترقية لمهني">
                                <span class="nav-icon-box w-8 h-8 rounded-lg flex items-center justify-center transition duration-200 flex-shrink-0
                                             <?php echo e(request()->is('upgrade') ? 'bg-amber-100 text-amber-600' : 'bg-amber-50 text-amber-500 group-hover:bg-amber-100 group-hover:text-amber-600'); ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-[18px] h-[18px]">
                        ...
                        <a href="<?php echo e(route('settings')); ?>"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition duration-200 group
                                  <?php echo e(request()->is('settings*') ? 'nav-link-active' : 'text-gray-600 hover:bg-gray-50 hover:text-indigo-600'); ?>"
                           title="الإعدادات">
                            <span class="nav-icon-box w-8 h-8 rounded-lg flex items-center justify-center transition duration-200 flex-shrink-0
                                         <?php echo e(request()->is('settings*') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-indigo-50 group-hover:text-indigo-500'); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-[18px] h-[18px]">
            ...
            <div class="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-white/95 backdrop-blur-md border-t border-gray-200/80 h-16 flex items-center justify-around px-2 shadow-[0_-2px_10px_rgba(0,0,0,0.06)]">
                <a href="<?php echo e(route('home')); ?>" class="flex flex-col items-center gap-0.5 px-3 py-1 rounded-lg transition <?php echo e(request()->is('/') ? 'text-indigo-600' : 'text-gray-400 hover:text-indigo-500'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"/>
                    </svg>
                    <span class="text-[10px] font-bold">الرئيسية</span>
                </a>
                <a href="<?php echo e(route('search')); ?>" class="flex flex-col items-center gap-0.5 px-3 py-1 rounded-lg transition <?php echo e(request()->is('search*') ? 'text-indigo-600' : 'text-gray-400 hover:text-indigo-500'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"/>
                    </svg>
                    <span class="text-[10px] font-bold">البحث</span>
                </a>
                <a href="<?php echo e(route('requests.index')); ?>" class="flex flex-col items-center gap-0.5 px-3 py-1 rounded-lg transition <?php echo e(request()->is('requests') ? 'text-indigo-600' : 'text-gray-400 hover:text-indigo-500'); ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"/>
                    </svg>
...
<?php /**PATH C:\Users\Mugahed\Desktop\MyMetier\resources\views/components/layouts/app-shell.blade.php ENDPATH**/ ?>