                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4" wire:loading.class="invisible">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col hover:shadow-md transition group relative">
                            <!-- Link Overlay -->
                            <a href="<?php echo e(route('requests.show', $req->id)); ?>" class="absolute inset-0 z-10 w-full h-full"></a>

                            <div class="flex justify-between items-start mb-4">
                                <h3 class="font-bold text-gray-900 text-lg group-hover:text-indigo-600 transition truncate w-full pl-4" title="<?php echo e($req->title); ?>"><?php echo e($req->title); ?></h3>
                            </div>
                            
                            <div class="flex flex-wrap gap-2 mb-6 text-sm text-gray-600 font-medium">
                                <span class="bg-indigo-50 text-indigo-700 px-3 py-1 rounded-lg border border-indigo-100"><?php echo e(optional($req->category)->name); ?></span>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg border border-gray-200"><?php echo e(optional($req->city)->name); ?></span>
                            </div>
...
<?php /**PATH C:\Users\Mugahed\Desktop\MyMetier\resources\views/livewire/public-requests-page.blade.php ENDPATH**/ ?>