<div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$profile): ?>
            <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-16 text-center max-w-2xl mx-auto mt-10">
                ...
                <a href="<?php echo e(route('home')); ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-8 rounded-xl transition shadow-sm inline-block">
                    العودة للرئيسية
                </a>
            </div>
        <?php else: ?>
            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->profile_status === 'pending_review'): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->profile_status === 'rejected'): ?>
                <div class="bg-amber-50 border border-amber-200 rounded-2xl p-5 mb-6 flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('upgrade')); ?>" class="inline-block text-sm font-bold text-amber-700 bg-white border border-amber-200 hover:bg-amber-50 px-4 py-2 rounded-lg transition shadow-sm">تعديل وإعادة الإرسال</a>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->profile_status === 'suspended'): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('upgrade_success')): ?>
                <div class="bg-green-50 border border-green-200 text-green-700 px-5 py-4 rounded-2xl mb-6 flex items-center gap-3">
                    ...
                    <p class="font-bold"><?php echo e(session('upgrade_success')); ?></p>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <!-- Dashboard Header -->
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 mb-8 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
                ...
                <div class="flex items-center gap-5 relative z-10 w-full md:w-auto">
                    <div class="w-20 h-20 bg-indigo-600 rounded-full flex items-center justify-center border-4 border-indigo-50 shadow-sm shrink-0">
                        <span class="text-3xl font-bold text-white"><?php echo e(mb_substr($profile->display_name, 0, 1)); ?></span>
                    </div>
                    <div>
                        <h1 class="text-2xl font-extrabold text-gray-900 mb-2"><?php echo e($profile->display_name); ?></h1>
                        <div class="flex flex-wrap items-center gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->verification_status === 'verified'): ?>
                            ...
                            <?php elseif($profile->profile_status === 'active'): ?>
                                <a href="<?php echo e(route('verification.request')); ?>" class="bg-indigo-50 text-indigo-700 text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1 border border-indigo-200 hover:bg-indigo-100 transition">
                ...
                <div class="flex gap-4 w-full md:w-auto mt-4 md:mt-0 relative z-10">
                    <div class="bg-gray-50 border border-gray-100 rounded-xl px-5 py-3 text-center flex-1 md:flex-none">
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e($profile->views_count); ?></p>
                    </div>
                    <div class="bg-gray-50 border border-gray-100 rounded-xl px-5 py-3 text-center flex-1 md:flex-none">
                        ...
                        <p class="text-xl font-bold text-amber-500 flex items-center justify-center gap-1">
                            <?php echo e(number_format($profile->rating_avg, 1)); ?>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <aside class="w-full lg:w-1/4 shrink-0">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-3 lg:sticky lg:top-24 flex lg:flex-col overflow-x-auto lg:overflow-visible no-scrollbar">
                        <button wire:click="setTab('profile')" class="flex items-center gap-3 px-5 py-4 rounded-xl text-right font-medium transition whitespace-nowrap lg:whitespace-normal <?php echo e($activeTab === 'profile' ? 'bg-indigo-50 text-indigo-700 shadow-sm border border-indigo-100' : 'text-gray-600 hover:bg-gray-50'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 <?php echo e($activeTab === 'profile' ? 'text-indigo-600' : 'text-gray-400'); ?>">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                            </svg>
                            الملف الشخصي
                        </button>
                        
                        <button wire:click="setTab('gallery')" class="flex items-center gap-3 px-5 py-4 rounded-xl text-right font-medium transition whitespace-nowrap lg:whitespace-normal <?php echo e($activeTab === 'gallery' ? 'bg-indigo-50 text-indigo-700 shadow-sm border border-indigo-100' : 'text-gray-600 hover:bg-gray-50'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 <?php echo e($activeTab === 'gallery' ? 'text-indigo-600' : 'text-gray-400'); ?>">
                              <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                            </svg>
                            معرض الأعمال
                        </button>

                        <button wire:click="setTab('increase-limit')" class="flex items-center gap-3 px-5 py-4 rounded-xl text-right font-medium transition whitespace-nowrap lg:whitespace-normal <?php echo e($activeTab === 'increase-limit' ? 'bg-indigo-50 text-indigo-700 shadow-sm border border-indigo-100' : 'text-gray-600 hover:bg-gray-50'); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 <?php echo e($activeTab === 'increase-limit' ? 'text-indigo-600' : 'text-gray-400'); ?>">
                ...
                <section class="flex-1">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'profile'): ?>
                        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('profile_success')): ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8">
                                <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center flex-wrap gap-2 border-b border-gray-100 pb-4">
                                    ...
                                    <span class="mr-auto text-sm font-medium px-4 py-1.5 rounded-full <?php echo e($canUpload ? 'bg-indigo-50 text-indigo-700 border border-indigo-100' : 'bg-red-50 text-red-700 border border-red-100'); ?>">
                                        الاستهلاك: <span class="font-bold font-mono" dir="ltr"><?php echo e($currentGalleryCount); ?> / <?php echo e($galleryLimit); ?></span> صورة
                                    </span>
                                </h2>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('gallery_success')): ?>
                                    <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl mb-6 flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" /></svg>
                                        <?php echo e(session('gallery_success')); ?>
                                            ...
                                            <div class="md:col-span-2">
                                                ...
                                                <div class="flex items-center justify-center w-full">
                                                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-indigo-50 hover:border-indigo-300 transition relative overflow-hidden">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($newImage): ?>
                                                            <div class="absolute inset-0 z-10 bg-indigo-50/90 flex flex-col items-center justify-center">
                                                                ...
                                                                <p class="text-xs text-indigo-500 font-mono" dir="ltr"><?php echo e($newImage->getClientOriginalName()); ?></p>
                                                            </div>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['imageTitle'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <div>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['imageSortOrder'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gallery->isEmpty()): ?>
                                ...
                                <?php else: ?>
                                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <div class="relative group aspect-square rounded-2xl overflow-hidden bg-gray-100 border border-gray-200 shadow-sm">
                                                <img src="<?php echo e(!empty($img->image_path) ? asset('storage/' . $img->image_path) : asset('/images/default-profile.png')); ?>" alt="<?php echo e($img->title); ?>" class="w-full h-full object-cover">
                                                ...
                                                <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col items-center justify-center p-4">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($img->title): ?>
                                                        <p class="text-white text-sm font-bold text-center mb-4 truncate w-full"><?php echo e($img->title); ?></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    
                                                    <button wire:click="deleteImage(<?php echo e($img->id); ?>)" wire:confirm="هل أنت متأكد من حذف هذه الصورة نهائياً؟" class="bg-red-500 hover:bg-red-600 text-white rounded-full p-2.5 shadow-md transform hover:scale-110 transition">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'increase-limit'): ?>
                        <div class="space-y-6">
                            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-8">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('limit_request_success')): ?>
                                    <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl mb-6 flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" /></svg>
                                        <?php echo e(session('limit_request_success')); ?>

                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasPendingLimitRequest): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <form wire:submit="submitLimitIncreaseRequest" class="space-y-6">
                                        <div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['requestedLimit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                        ...
                                        <div class="pt-2">
                                            ...
                                            <div class="flex flex-col items-center justify-center w-full">
                                                <label for="proof-file" class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-indigo-50 hover:border-indigo-300 transition relative overflow-hidden">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paymentProofImage): ?>
                                                        <div class="absolute inset-0 z-10 bg-indigo-50/90 flex flex-col items-center justify-center">
                                                            <p class="text-sm font-bold text-indigo-700 mb-1">تم إرفاق الملف:</p>
                                                            <p class="text-xs text-indigo-500 font-mono" dir="ltr"><?php echo e($paymentProofImage->getClientOriginalName()); ?></p>
                                                        </div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['paymentProofImage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1 block"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH C:\Users\Mugahed\Desktop\MyMetier\resources\views/livewire/professional-dashboard.blade.php ENDPATH**/ ?>