<div class="min-h-screen bg-white">
    ...
    <main>
                        ...
                        <div class="bg-white p-3 rounded-2xl shadow-xl border border-gray-100 flex flex-col md:flex-row gap-3 relative z-20">
                            ...
                            <div class="flex-1 relative">
                                ...
                                <select wire:model.live="cityId" class="w-full text-right appearance-none bg-gray-50 border border-gray-100 text-gray-900 rounded-xl pr-11 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition shadow-sm">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($this->featuredProfessionals) > 0): ?>
        <div class="bg-indigo-50 py-16 sm:py-24 border-y border-indigo-100">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-right">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->featuredProfessionals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <a href="<?php echo e(route('profile.show', $profile['id'])); ?>" class="bg-white rounded-2xl shadow-sm border border-indigo-200 p-6 flex flex-col hover:shadow-xl hover:-translate-y-1 transition duration-300 relative group overflow-hidden">
                            <!-- Featured Badge -->
                            ...
                            <div class="flex items-center gap-4 mb-4 mt-2">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition"><?php echo e($profile['display_name']); ?></h3>
                                    <p class="text-sm text-indigo-600 font-medium"><?php echo e($profile['category_name']); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="mt-auto pt-4 border-t border-gray-50 flex items-baseline justify-between">
                                <div class="flex items-center text-sm text-gray-500 gap-1.5">
                                    ...
                                    <?php echo e($profile['city_name']); ?>

                                </div>
                                <div class="flex items-center gap-1 bg-yellow-50 px-2 py-1 rounded-md border border-yellow-200">
                                    <span class="text-sm font-bold text-yellow-700"><?php echo e(number_format($profile['rating_avg'], 1)); ?></span>
        ...
        <div class="bg-gray-50 py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="mx-auto mt-16 grid max-w-2xl grid-cols-2 gap-x-8 gap-y-10 sm:grid-cols-3 lg:mx-0 lg:max-w-none lg:grid-cols-6 pl-4 pr-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <a href="/search?category=<?php echo e($category->id); ?>" class="group flex flex-col items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-indigo-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                            <div class="flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50 text-indigo-600 mb-4 group-hover:scale-110 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm border border-indigo-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category->icon): ?>
                                    <span class="w-8 h-8 flex items-center justify-center <?php echo str_contains($category->icon, '<svg') ? '' : 'text-3xl'; ?>"><?php echo $category->icon; ?></span>
                                <?php else: ?>
                            ...
                            <h3 class="text-base font-semibold text-gray-900 text-center"><?php echo e($category->name); ?></h3>
                        </a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>
        ...
        <div class="bg-white py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($this->popularProfessionals) > 0): ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-right">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->popularProfessionals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <a href="<?php echo e(route('profile.show', $profile['id'])); ?>" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col hover:shadow-xl hover:-translate-y-1 transition duration-300 relative group overflow-hidden">
                                <!-- Badge -->
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile['is_featured'] ?? false): ?>
                                <div class="absolute top-0 right-0 bg-yellow-400 text-yellow-900 text-xs font-bold px-4 py-1.5 rounded-bl-lg z-10 shadow-sm flex items-center gap-1">
                                    مميز ⭐
                                </div>
                                <?php else: ?>
                                ...
                                <div class="flex items-center gap-4 mb-4 mt-2">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition"><?php echo e($profile['display_name']); ?></h3>
                                        <p class="text-sm text-indigo-600"><?php echo e($profile['category_name']); ?></p>
                                    </div>
                                </div>
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto">
        <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <div class="mt-8 md:order-1 md:mt-0">
                <p class="text-center text-xs leading-5 text-gray-500">&copy; <?php echo e(date('Y')); ?> MyMetier. جميع الحقوق محفوظة.</p>
            </div>
        </div>
    </footer>
</div>
<?php /**PATH C:\Users\Mugahed\Desktop\MyMetier\resources\views/livewire/home-page.blade.php ENDPATH**/ ?>