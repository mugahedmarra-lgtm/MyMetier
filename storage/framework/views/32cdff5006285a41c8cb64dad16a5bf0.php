            ...
            <aside class="w-full lg:w-72 flex-shrink-0">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->search || $this->category_id || $this->city_id || $this->district_id || $this->availability_status || $this->sort !== 'best'): ?>
                    ...
                    <div class="mb-5">
                        ...
                        <select id="filter-district" wire:model.live.debounce.300ms="district_id"
                            <?php if(empty($this->city_id)): ?> disabled <?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center justify-between mb-6">
                    <p class="text-sm text-gray-500">
                        تم العثور على <span class="font-semibold text-gray-900"><?php echo e($this->results->total()); ?></span> نتيجة
                    </p>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->results->count() > 0): ?>
                    <div wire:loading.class="invisible" class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'profile-'.e($profile->id).''; ?>wire:key="profile-<?php echo e($profile->id); ?>" class="bg-white rounded-2xl shadow-md border border-gray-100 hover:shadow-xl hover:border-indigo-100 hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col h-full relative">
                                ...
                                <div class="p-6 flex flex-col flex-1">
                                    ...
                                    <div class="flex items-start justify-between mb-4 gap-4">
                                        <div class="flex items-center gap-3 min-w-0 flex-1">
                                            ...
                                            <div class="flex-shrink-0 w-12 h-12 rounded-full overflow-hidden bg-indigo-50 border border-indigo-100 flex items-center justify-center">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->user?->avatar): ?>
                                                    <img src="<?php echo e(Storage::url($profile->user->avatar)); ?>" alt="<?php echo e($profile->display_name); ?>" class="w-full h-full object-cover">
                                                <?php else: ?>
                                                    <span class="text-lg font-bold text-indigo-600"><?php echo e(mb_substr($profile->display_name, 0, 1)); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            
                                            <div class="min-w-0">
                                                <h3 class="text-lg font-bold text-gray-900 truncate"><?php echo e($profile->display_name); ?></h3>
                                                <p class="text-sm text-gray-500 mt-0.5"><?php echo e($profile->category?->name ?? '—'); ?></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            ...
                                            <!-- Favorite Action -->
                                            <button wire:click.prevent="toggleFavorite(<?php echo e($profile->id); ?>)" class="mr-2 p-1.5 rounded-full hover:bg-red-50 text-gray-400 hover:text-red-500 transition duration-300 focus:outline-none flex-shrink-0 relative group" title="أضف للمفضلة" wire:loading.attr="disabled">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($profile->id, $this->favoritedProfileIds)): ?>
                                                ...
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <span wire:loading wire:target="toggleFavorite(<?php echo e($profile->id); ?>)" class="absolute inset-0 flex items-center justify-center bg-white/80 rounded-full">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile->description): ?>
                                        <p class="text-sm text-gray-600 mb-6 line-clamp-2 leading-relaxed">
                                            <?php echo e(\Illuminate\Support\Str::limit($profile->description, 100)); ?>
...
<?php /**PATH C:\Users\Mugahed\Desktop\MyMetier\resources\views/livewire/search-page.blade.php ENDPATH**/ ?>