<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        {{-- Page Title --}}
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900">أفضل {{ $category->name }}</h1>
            <p class="mt-1 text-sm text-gray-500">ابحث عن أفضل {{ $category->name }} مع تقييمات حقيقية للمهنيين.</p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="w-full lg:w-72 flex-shrink-0">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        @if($this->city_id || $this->district_id || $this->availability_status)
            ...
            <div class="flex-1">
                ...
                <div class="relative min-h-[300px]">
                    <div wire:loading.delay wire:target="city_id, district_id, availability_status, gotoPage, previousPage, nextPage" class="absolute inset-0 z-50 flex items-center justify-center bg-white/80 backdrop-blur-sm rounded-2xl">
                ...
                @else
                    ...
                    <div wire:loading.class="invisible" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-16 text-center">
                        ...
                        <p class="text-sm text-gray-500 mb-6">لم يتم العثور على نتائج للـ {{ $category->name }}، حاول تغيير الفلاتر</p>
