<div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 transition-colors duration-200">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
            أو <a href="{{ route('register') }}" class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 transition">أنشئ حساباً جديداً</a>
        </p>
    </div>
            ...
            <form wire:submit="login" class="space-y-6 relative z-10">
                <div>
                    ...
                    <div class="mt-1 relative">
                        ...
                        @error('phone') <span class="text-red-500 text-xs mt-1 w-full block">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="mt-1 relative">
                        ...
                        @error('password') <span class="text-red-500 text-xs mt-1 w-full block">{{ $message }}</span> @enderror
                    </div>
                </div>
